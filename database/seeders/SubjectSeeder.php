...
class SubjectSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $subjects = [
            ...
            ['code' => 'COMP 003',     'title' => 'Computer Programming 2',                             'units' => 3, 'type' => 'lecture'],
            ['code' => 'COMP 004',     'title' => 'Discrete Structures 1',                              'units' => 3, 'type' => 'lecture'],
            ...
            ['code' => 'GEED 033',     'title' => 'Pagsasalin sa Kontekstong Filipino',                 'units' => 3, 'type' => 'GE'],
            ['code' => 'MATH 017',     'title' => 'Differential Calculus for Computer Science Students','units' => 3, 'type' => 'lecture'],
            ['code' => 'NSTP 002',     'title' => 'National Service Training Program 2',                'units' => 3, 'type' => 'NSTP'],
            ['code' => 'PATHFIT 2',    'title' => 'Physical Activity Towards Health and Fitness 2',     'units' => 2, 'type' => 'PE'],

            // ── 2nd Year, 1st Semester ────────────────────────────
            ['code' => 'COSC 201',     'title' => 'Logic Design and Digital Computer Circuits',         'units' => 3, 'type' => 'lecture'],
            ['code' => 'COSC 202',     'title' => 'Modeling and Simulation',                            'units' => 3, 'type' => 'lecture'],
            ['code' => 'COMP 005',     'title' => 'Discrete Structures 2',                              'units' => 3, 'type' => 'lecture'],
            ['code' => 'COMP 006',     'title' => 'Data Structures and Algorithms',                     'units' => 3, 'type' => 'lecture'],
            ['code' => 'COMP 009',     'title' => 'Object Oriented Programming',                        'units' => 3, 'type' => 'lecture'],
            ['code' => 'ELEC CS-FE1',  'title' => 'BSCS Free Elective 1',                              'units' => 3, 'type' => 'lecture'],
            ['code' => 'GEED 008',     'title' => 'Ethics/Etika',                                       'units' => 3, 'type' => 'GE'],
            ['code' => 'PATHFIT 3',    'title' => 'Physical Activity Towards Health and Fitness 3',     'units' => 2, 'type' => 'PE'],

            // ── 2nd Year, 2nd Semester ────────────────────────────
            ['code' => 'COSC 203',     'title' => 'Design and Analysis of Algorithms',                  'units' => 3, 'type' => 'lecture'],
            ['code' => 'COMP 007',     'title' => 'Operating Systems',                                  'units' => 3, 'type' => 'lecture'],
            ['code' => 'COMP 008',     'title' => 'Data Communications and Networking',                 'units' => 3, 'type' => 'lecture'],
            ['code' => 'COMP 010',     'title' => 'Information Management',                             'units' => 3, 'type' => 'lecture'],
            ...
            ['code' => 'PATHFIT 4',    'title' => 'Physical Activity Towards Health and Fitness 4',     'units' => 2, 'type' => 'PE'],

            // ── 3rd Year, 1st Semester ────────────────────────────
            ['code' => 'COSC 301',     'title' => 'Computer Organization and Assembly Language',        'units' => 3, 'type' => 'lecture'],
            ['code' => 'COSC 302',     'title' => 'Automata and Language Theory',                       'units' => 3, 'type' => 'lecture'],
            ['code' => 'COSC 303',     'title' => 'Principles of Programming Languages',                'units' => 3, 'type' => 'lecture'],
            ['code' => 'COMP 013',     'title' => 'Human Computer Interaction',                         'units' => 3, 'type' => 'lecture'],
            ['code' => 'COMP 015',     'title' => 'Fundamentals of Research',                           'units' => 3, 'type' => 'lecture'],
            ['code' => 'COMP 019',     'title' => 'Applications Development and Emerging Technologies', 'units' => 3, 'type' => 'lecture'],
            ['code' => 'ELEC CS-E1',   'title' => 'BSCS Elective 1',                                   'units' => 3, 'type' => 'lecture'],

            // ── 3rd Year, 2nd Semester ────────────────────────────
            ['code' => 'COSC 304',     'title' => 'Introduction to Artificial Intelligence',            'units' => 3, 'type' => 'lecture'],
            ['code' => 'COSC 305',     'title' => 'CS Thesis Writing 1',                                'units' => 3, 'type' => 'lecture'],
            ['code' => 'COMP 016',     'title' => 'Web Development',                                    'units' => 3, 'type' => 'lecture'],
            ['code' => 'COMP 020',     'title' => 'Information Assurance and Security',                 'units' => 3, 'type' => 'lecture'],
            ['code' => 'COMP 021',     'title' => 'Software Engineering 1',                             'units' => 3, 'type' => 'lecture'],
            ['code' => 'ELEC CS-E2',   'title' => 'BSCS Elective 2',                                   'units' => 3, 'type' => 'lecture'],
            ['code' => 'GEED 006',     'title' => 'Art Appreciation',                                   'units' => 3, 'type' => 'GE'],

            // ── 3rd Year, Summer ──────────────────────────────────
            ['code' => 'COSC 306',     'title' => 'Practicum (200 hours)',                              'units' => 3, 'type' => 'lecture'],

            // ── 4th Year, 1st Semester ────────────────────────────
            ['code' => 'COSC 401',     'title' => 'CS Thesis Writing 2',                                'units' => 3, 'type' => 'lecture'],
            ['code' => 'COMP 022',     'title' => 'Software Engineering 2',                             'units' => 3, 'type' => 'lecture'],
