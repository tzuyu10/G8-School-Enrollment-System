...
<head>
    ...
    <title>Enroll | PUP Enrollment Portal</title>
        ...
        <div class="card shadow-sm" style="max-width:600px;">
            <div class="card-body p-4">
                <form action="{{ route('enroll.submit') }}" method="POST">
                    ...
                    {{-- Student type — inherited, read-only --}}
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="semester_id" name="semester_id"
                            ...
                            @foreach ($semesters as $sem)
                                <option value="{{ $sem->id }}"
                                    @selected(old('semester_id', $activeSemester?->id) === $sem->id)>
                        ...
                        <select id="program_id" name="program_id"
                            ...
                            @foreach ($programs as $program)
                                <option value="{{ $program->id }}"
                                    ...
                                    {{ $program->code }}
                                    @if($program->major) — {{ $program->major }}@endif
                    ...
                    <div class="mb-4">
                        ...
                        <select id="year_level_id" name="year_level_id"
                            ...
                            @foreach ($yearLevels as $yl)
                                <option value="{{ $yl->id }}" @selected(old('year_level_id') === $yl->id)>
                                    {{ $yl->label }}
                                </option>
                            @endforeach
                        </select>
