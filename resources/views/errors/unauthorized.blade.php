...
<head>
    ...
    <title>Unauthorized | PUP Enrollment Portal</title>
    @vite([
...
<section class="hero">
    ...
    <div class="hero-left" aria-hidden="true">
        <span class="eyebrow-badge">403 Error</span>
        <h1 class="hero-headline">
            ACCESS<br>
            NOT<br>
            <span class="text-gold">ALLOWED</span>
        </h1>
    </div>

    <div class="hero-right">
        <div class="login-card">
            <p class="card-title-custom mb-1">You cannot access this page</p>
            <p class="card-sub mb-4">Your account role does not have permission to open this section.</p>
